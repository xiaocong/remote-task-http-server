...
def when_ready(server):
    ...
    server.num_workers = 1  # make sure only one worker forked

    def file_change_monitor():
        server.log.info("Starting to monitor file changes of worker app...")
        modify_times = {}
        while True:
    ...
    gevent.spawn(file_change_monitor)
